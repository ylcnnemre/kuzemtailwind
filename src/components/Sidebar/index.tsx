...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 border-r border-[#2A4562] flex-col overflow-y-hidden bg-[#041324] duration-300 ease-linear dark:bg-[#041324]  lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className={"w-full"}>
          <h1 className='text-center text-white text-2xl text-yellow-300 italic '>
            KUZEM
          </h1>
        </NavLink>
